      ...
      <div className="container portfolio__container">
        ...
        <article className='portfolio__item'>
            ...
            <div className="portfolio__item-cta">
              <a href="https://github.com/Shreyash-Tripathii/bank" target="_blank" rel='noreferrer' className='btn'>Github</a>
            </div>
        ...
        <article className='portfolio__item'>
            ...
            <div className="portfolio__item-cta">
              <a href="https://github.com/Shreyash-Tripathii/auth-mern" target="_blank" rel='noreferrer' className='btn'>Github</a>  
            </div>
